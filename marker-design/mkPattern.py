...
# 07.01.2015 Slightly increase the size of the black dots as it is what seems to limit the range of detection.
# 11.01.2015 Started implementation of Reed-Solomon protected code.
